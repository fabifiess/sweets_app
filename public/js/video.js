...
(function () {
    ...
    t.ff = function (a, c) {
        ...
        videojs.$.ya({method: "GET", timeout: 45E3}, a);
        c = c || m();
        p = function () {
    ...
    s.Oc = function () {
        ...
        if (d = c.children)if (h = function (d, e) {
                c[d] !== b && (e = c[d]);
                e !== l && (a[d] = a.ba(d, e))
            }, t.i.isArray(d))for (var k = 0; k < d.length; k++)e = d[k], "string" == typeof e ? (g = e, e = {}) : g = e.name, h(g, e);
        else t.i.da(d, h)
    };
    s.V = q("");
    s.b = function (a, c, d) {
    ...
    s.e = function () {
        ...
        this.b(["canplay",
                "canplaythrough", "playing", "ended"], this.Ce);
    ...
    s.Ja = function () {
        ...
        if (c)for (var d = c.length - 1; 0 <= d; d--)a.ba(new t.Bb(this.k(), {rate: c[d] + "x"}));
        return a
    };
    s.Ca = function () {
    ...
    s.e = function () {
        ...
        if (!g || this.movingMediaElementInDOM === l) {
            ...
            g.player = a;
            if (a.q.qd)for (e = 0; e < a.q.qd.length; e++)c = a.q.qd[e], d = document.createElement("track"), d.Wb = c.Wb, d.label = c.label, d.hd = c.hd, d.src = c.src, "default"in c && d.setAttribute("default", "default"), g.appendChild(d);
            t.Ub(g, a.m())
        }
    ...
    t.g = t.j.extend({
        l: function (a, c, d) {
            ...
            var e = c.source;
            d = c.parentEl;
            var g = this.c = t.e("div", {id: a.id() + "_temp_flash"}), h = a.id() + "_flash_api", k = a.q, k = t.i.D({
    ...
    t.t = function (a) {
        ...
        Object.defineProperty(c, "activeCues", {
            get: function () {
                ...
                else for (a = 0; a < d.length; a++)-1 === ua.call(this.Ga,
                                                                  d[a]) && (A = f);
                this.Ga = d;
                r.qb(this.Ga);
                return r
    ...
    s.Ja = function () {
        for (var a = this.d.textTracks() || [], c = 0, d = a.length, e, g, h = this.H = []; c < d; c++)if (e = a[c], e.kind == this.fa)if (e.Dc) {
            g = e;
            break
        }
